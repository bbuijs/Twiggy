...
var RunningState = (function (_super) {
    ...
    RunningState.prototype.create = function () {
        ...
        barYellow.beginFill(0x1E6665);
        barYellow.drawRect(0, 0, 25, 50);
        maxHeight = -100;
        barYellow.height = 0;
...
var profileState = (function (_super) {
    __extends(profileState, _super);
    ...
    profileState.prototype.preload = function () {
        //loading the resourses
        //load the sprite of the resourses
        this.load.image('coin', "assets/images/coin.png");
    ...
    profileState.prototype.create = function () {
        this.back = new ButtonObject(this.game, 300, 40, 'x', this.backClicked);
        this.back.setSizes(40, 40);
        this.back.anchor.set(0.5);
        this.back.render();
        // this.game.add.sprite(300,40, 'x');
    ...
    profileState.prototype.locationPointer = function () {
    };
    profileState.prototype.action = function () {
        // aangeroepen bij elke shop item apple
    };
    //user this for rendering
    profileState.prototype.render = function () {
        //
    };
    profileState.prototype.update = function () {
    };
    return profileState;
}(Phaser.State));
